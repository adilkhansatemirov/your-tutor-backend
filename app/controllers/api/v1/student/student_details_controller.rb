class Api::V1::Student::StudentDetailsController < ApplicationController
  before_action :authenticate_api_user!, :require_client

  # POST /client/clients/connect_card
  def connect_card
    Student::StudentDetailsService.connect_card(connect_card_params, current_api_user)
    render json: { message: "сredit card successfully added" }, status: 200
  end

  # POST /client/clients/connect_bank
  def connect_bank
    Student::StudentDetailsService.connect_bank(connect_bank_params, current_api_user)
