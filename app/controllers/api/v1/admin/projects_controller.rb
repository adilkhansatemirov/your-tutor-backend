class Api::V1::Admin::ProjectsController < ApplicationController
  ...
  sortable_by 'projects.title', 'students.first_name', 'freelancers.first_name'
  ...
  def projects_scope
    Project.joins("INNER JOIN student_details on projects.student_detail_id = student_details.id")
